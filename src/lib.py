func_definition = {
    ...
    'dumpF': (None, 'dump.h'),
    'dump0F': (None, 'dump.h'),
    'format': ('string', 'format.h'),
    'mod': ('int', 'mod.h'),
    'mod_mul': ('int', 'mod_mul.h'),
    'int': ('int', None),
    'uint': ('unsigned int', None),
    'short': ('short', None),
    'char': ('char', None),
...
dependency = {
    ...
    'srand49.h': ['mrand49.h'],
    'fast_weak_counter32.h': ['tuple', 'cstring', 'cassert', 'fast_array.h'],
    'fast_weak_counter64.h': ['tuple', 'cstring', 'cassert', 'fast_array.h'],
